...
@section('title', $subcategory->name . ' Books')
...
@section('frontend_content')
    <main class="main">
        <!-- breadcrumb -->
        <x-frontend.pages.common.breadcrumb :title="$subcategory->name . ' Books'" :breadcrumb="[['name' => 'Home', 'url' => route('home')], ['name' => 'Books', 'url' => route('books')], ['name' => $subcategory->name, 'url' => '#']]" />
        <!-- breadcrumb end -->
                            ...
                            <div class="widget mb-4">
                                ...
                                <div class="category">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="form-check">
                                                <input class="form-check-input category-filter" type="checkbox" name="category" value="{{ $cat->id }}" id="cat{{ $cat->id }}" {{ in_array($cat->id, explode(',', request('category', ''))) ? 'checked' : '' }} />
