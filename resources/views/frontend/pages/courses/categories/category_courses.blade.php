...
@section('frontend_content')
    <main class="main">
        <!-- breadcrumb -->
        <x-frontend.pages.common.breadcrumb :title="$category->name . ' Courses'" :breadcrumb="[['name' => 'Home', 'url' => route('home')], ['name' => 'Courses', 'url' => route('courses')], ['name' => $category->name, 'url' => '#']]" />
        <!-- breadcrumb end -->
