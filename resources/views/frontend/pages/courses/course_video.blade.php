 ...
 @section('frontend_content')
     <main class="main">
         ...
         <div class="container mt-4">
             <div class="row">
                 <div class="col-12">
                     <a href="{{ url()->previous() }}" class="back-to-course">
                         <i class="feather-arrow-left"></i> কোর্সে ফিরে যান
                     </a>
                 </div>
             </div>
             ...
             <div class="row">
                     ...
                     <div class="video-player-section" data-aos="fade-right">
                         ...
                         <div class="video-container">
                             @if (isset($notification))
                                 <!-- Show restricted message instead of video -->
                             ...
                             @elseif($module->link)
                                 ...
                                 <div class="plyr__video-embed" id="player" style="position: relative;">
                                     <!-- Custom thumbnail overlay to hide video title -->
                                     <img id="thumbnail"
                         ...
                         <div class="toolbar">
                             <button class="btn btn-soft" id="prevVideoBtn" onclick="navigateVideo('prev')"><i class="feather-skip-back"></i> Previous</button>
                             <button class="btn btn-soft" id="nextVideoBtn" onclick="navigateVideo('next')">Next <i class="feather-skip-forward"></i></button>
                         </div>
                ...
                @endif --}}
                 ...
                 <div class="col-lg-4">
                     <div class="p-0" data-aos="fade-left">
                         <div class="module-list-title px-3 pt-3">
                             <h5 class="mb-0">কোর্সের বিষয়বস্তু</h5>
                         </div>
                         <div class="sidebar-scroll px-3 pb-3">
     ...
     <script>
        ...
        `;
             ...
             fetch(`{{ route('ajax.course.video.data', '') }}/${moduleId}`, {
                ...
                `;
                     showToast('Failed to load video. Please try again. Error: ' + error.message, 'error');
                 });
         }
         ...
         function updateVideoPlayer(data) {
             // Check if the response was successful and user has access
            ...
            `;
             ...
             // Build the video player HTML based on the link type
             let videoPlayerHtml = '';
             if (module.live_record === 'live' && module.date && module.time) {
                 // Handle scheduled live session
                 ...
                 if (startAt) {
                     ...
                     let joinButtonHtml = '';
                     const showJoin = (module.free_paid === 'free') || data.isEnrolled;
                     if (showJoin) {
                         joinButtonHtml =
                             `<a id="bigJoinBtn" href="${module.link || '#'}" target="_blank" class="btn btn-primary" style="display:none">Join Meeting</a>`;
                     } else {
                         joinButtonHtml = '';
                     }

                     videoPlayerHtml = `
                    <div id="bigCountdown" class="countdown-panel" style="display:block;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <div style="font-size:16px; opacity:0.9;">Live session</div>
                                <div class="countdown-time" id="bigCountdownTime">Starts soon…</div>
                        ...
                        <div class="small mt-2">Start: ${new Date(startAt).toLocaleString()} | Visible until: ${new Date(endAt).toLocaleString()}</div>
                    </div>
                `;
                 } else {
                     videoPlayerHtml = '<div id="bigCountdown" class="countdown-panel" style="display:none;"></div>';
                 }
             } else {
                 videoPlayerHtml = '<div id="bigCountdown" class="countdown-panel" style="display:none;"></div>';
             }

             // Add the main player HTML
             videoPlayerHtml += `
            <div class="plyr__video-embed" id="player" style="position: relative;">
                <img id="thumbnail"
                     src="https://cdn.prod.website-files.com/62d84e447b4f9e7263d31e94/6399a4d27711a5ad2c9bf5cd_ben-sweet-2LowviVHZ-E-unsplash-1.jpeg"
        ...
        `;
         ...
         function showToast(message, type = 'error') {
             ...
             toast.className = `toastr-message ${type}`;
             toast.innerHTML = `
            ${message}
        ...
        `;
         ...
         @if (session('notification'))
             showToast("{{ session('notification') }}", 'error');
