                                        ...
                                        <tbody>
                                            @forelse($orders as $order)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="responsive-hidden">{{ $order->created_at?->format('F j, Y') ?? optional($order->date)->format('F j, Y') }}
                                                    </td>
                                                    <td class="responsive-hidden">{{ $order->currency ?? 'BDT' }}{{ number_format($order->amount, 2) }}
                                                    </td>
                                                    <td class="responsive-hidden"><span class="badge {{ $badgeClass }}">{{ $displayStatus }}</span>
                                                    </td>
                                                    <td>
