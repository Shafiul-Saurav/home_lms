...
@section('title', 'Book Order Details')

@section('frontend_content')
    <main class="main">
        <!-- breadcrumb -->
        <x-frontend.pages.common.breadcrumb :title="'Book Order Details'" :breadcrumb="[
            ['name' => 'Home', 'url' => route('home')],
            ['name' => 'Book Orders', 'url' => route('user.book.orders')],
                        ...
                        <div class="user-wrapper">
                            <div class="user-card">
                                <div class="header d-flex justify-content-between align-items-center">
                                    <h4 class="title">Book Order Details</h4>
                                    <a href="{{ route('user.book.orders') }}" class="theme-btn">Back to Orders</a>
                                </div>
                                        ...
                                        <table class="table table-borderless text-nowrap">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $order->order_number ?? sprintf('#%s', str_pad($order->id, 6, '0', STR_PAD_LEFT)) }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Book</th>
                                                    <td>
                                                        <a href="{{ route('book.details', $order->book_id) }}" class="text-decoration-none">
                                                            {{ $order->book?->title ?? $order->book?->name ?? 'Book details' }}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span class="text-primary">{{ $order->payment_method ?? 'Unknown' }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span class="badge badge-primary">{{ ucfirst($order->payment_status ?? 'Unknown') }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <span class="badge badge-primary">{{ ucfirst($order->status ?? 'Unknown') }}</span>
                                                        @endif
                                                    </td>
                                                </tr>
