...
@section('title', 'Course Order Details')

@section('frontend_content')
    <main class="main">
        <!-- breadcrumb -->
        <x-frontend.pages.common.breadcrumb :title="'Course Order Details'" :breadcrumb="[
            ['name' => 'Home', 'url' => route('home')],
            ['name' => 'Course Orders', 'url' => route('user.course.orders')],
                        ...
                        <div class="user-wrapper">
                            <div class="user-card">
                                <div class="header d-flex justify-content-between align-items-center">
                                    <h4 class="title">Course Order Details</h4>
                                    <a href="{{ route('user.course.orders') }}" class="theme-btn">Back to Orders</a>
                                </div>
                                        ...
                                        <table class="table table-borderless text-nowrap">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Course</th>
                                                    <td>
                                                        <a href="{{ route('course.details', $order->course_id) }}"
                                                            class="text-decoration-none">
                                                            {{ $order->course?->title ?? 'Course details' }}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
