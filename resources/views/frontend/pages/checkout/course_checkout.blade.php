                        ...
                        <div class="col-lg-7">
                            <div class="auth-form">
                                <div class="auth-header" style="text-align: left;">
                                    ...
                                    <p>Fill out the information below to complete your enrollment</p>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="form-icon">
                                                ...
                                                <textarea name="address" class="form-control" rows="3" placeholder="Full Address" style="padding-top: 15px;"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-5">
                            <div class="order-summary-card">
                                ...
                                <div class="course-item-box d-flex align-items-center">
                                    <img src="{{ asset('uploads/courses/' . $course->image) }}" alt="{{ $course->name }}" style="width: 90px; height: 70px; object-fit: cover; border-radius: 10px; margin-right: 15px;">
                                    <div>
                                        <h6 class="mb-1" style="font-weight: 700;">{{ $course->name }}</h6>
                                        <p class="mb-0 text-muted small">Course ID: #{{ $course->id }}</p>
                                    </div>
                                </div>
