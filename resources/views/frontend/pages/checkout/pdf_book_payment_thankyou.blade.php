                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="success-card">
                            ...
                            <p class="text-muted">Thank you for your purchase. Your digital book is now available.</p>
                            ...
                            <div class="order-details-box">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <span>PDF Book:</span>
                                    <span class="fw-bold text-dark">{{ $order->pdfBook->name }}</span>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="d-flex gap-3 justify-content-center">
                                <a href="{{ route('pdf.books') }}" class="theme-btn">Browse More PDF Books</a>
                                <a href="{{ route('user.dashboard') }}" class="theme-btn" style="background: #333;">Go to Dashboard</a>
                            </div>
                            <p class="mt-4 small text-muted">A download link has been sent to your email: <strong>{{ $order->email }}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
