<section class="testimonials-area pb-100">
    <div class="container">
        ...
        <div class="testimonials-wrap owl-carousel owl-theme">
            ...
            <div class="single-testimonials single_testimonial" style="background-image: url('{{ asset('assets/frontend/img/testimonials/testimonials-bg.png') }}')">
                <ul>
                    @for ($i = 1; $i <= 5; $i++)
                        <li class=""><i class="bx bxs-star {{ $i <= $testimonial->rating ? 'text_warning' : 'text_light' }}"></i></li>
                    @endfor
                </ul>
                ...
                <div class="testimonials-content">
                    @if ($testimonial->user->profile->profileImage??null)
                        <img src="{{ asset($testimonial->user->profile->profileImage->profile_image??null) }}" alt="Image">
                    @else
