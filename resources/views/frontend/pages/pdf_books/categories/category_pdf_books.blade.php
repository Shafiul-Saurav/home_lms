...
@section('title', 'PDF Books - ' . $category->name)
...
@section('frontend_content')
    <main class="main">
        <!-- breadcrumb -->
        <x-frontend.pages.common.breadcrumb :title="'PDF Category: ' . $category->name" :breadcrumb="[['name' => 'Home', 'url' => route('home')], ['name' => 'PDF Books', 'url' => route('pdf.books')], ['name' => $category->name, 'url' => '#']]" />
        <!-- breadcrumb end -->
                            ...
                            <div class="filter-widget">
                                ...
                                <ul class="category-list list-unstyled">
                                    @foreach ($categories as $cat)
                                        <li>
                                            <a href="{{ route('pdf.book.category', $cat->slug) }}" class="{{ $category->id == $cat->id ? 'active' : '' }}">
                                                {{ $cat->name }}
                        ...
                        <div class="row g-4">
                                    ...
                                    <div class="course-item">
                                        ...
                                        <div class="course-content">
                                            <div class="course-meta">
                                                <span class="category"><i class="far fa-bookmark"></i> {{ $book->pdfBookCategory->name ?? $category->name }}</span>
                                            </div>
                            ...
                            @empty
                                <div class="col-12 text-center py-5">
                                    <h4 class="text-muted">No PDF books found in this category.</h4>
