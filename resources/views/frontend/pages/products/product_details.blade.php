...
@push('frontendone_style')
    ...
    <style>
        ...
        .product-detail-hero .product-meta {
            display: flex;
            flex-wrap: wrap;
            gap: 12px;
            margin-top: 18px;
        ...
        .product-info-card .price-box {
            margin-bottom: 20px;
        }
        .product-info-card .price-box h2 {
            margin: 0;
            font-size: 2rem;
            color: #16335c;
            font-weight: 900;
        }
        .product-info-card .price-old-row del {
            color: #9aa1af;
            font-size: 1rem;
        }
    ...
    <main class="main">
        <x-frontend.pages.common.breadcrumb
            ...
            :breadcrumb="[
                ...
                ['name' => $productInfo->category->name ?? 'Products', 'url' => route('category.products', $productInfo->category_id)],
            ...
            <div class="container">
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        ...
                        <p class="mb-0" style="color: rgba(255,255,255,.82); max-width:760px;">{!! Str::limit(strip_tags($productInfo->long_description ?? $productInfo->description), 200) !!}</p>
        ...
        <section class="section-padding py-5">
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="col-lg-4">
                        <div class="product-related-card p-4 mb-4">
