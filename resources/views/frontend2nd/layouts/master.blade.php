...
<head>
    ...
    <!-- Styles -->
    @include('frontend2nd.layouts.include.style')
...
<body>
    ...
    <div class="shadow-lg">
        <!-- Header -->
        @include('frontend2nd.layouts.include.header')
        
        <!-- Navigation -->
        @include('frontend2nd.layouts.include.navbar')
    </div>
    
    <!-- Mobile Sidebar -->
    @include('frontend2nd.layouts.include.sidebar')
    
    <!-- Main Content -->
    @yield('frontend2nd_content')
    ...
    <!-- Footer -->
    @include('frontend2nd.layouts.include.footer')
    
    <!-- Scripts -->
    @include('frontend2nd.layouts.include.script')
