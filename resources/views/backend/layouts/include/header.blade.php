                        ...
                        <div class="d-flex order-lg-2">
                                    ...
                                    <div class="px-2 pb-4 pt-2">
                                        <div class="row mb-2">
                                            <div class="col d-flex">
                                                <a href="maps1.html" class="dropdown-menu-item text-muted source-logo-container">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col d-flex p-0">
                                                <a href="file-manager.html" class="dropdown-menu-item text-muted source-logo-container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col d-flex p-0">
                                                <a href="blog-php.html" class="dropdown-menu-item text-muted source-logo-container">
                                            ...
                                            <div class="col d-flex">
                                                <a href="form-elements.html" class="dropdown-menu-item text-muted source-logo-container">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
                                    ...
                                    <div class="message-menu ps2 overflow-hidden">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('assets/backend')}}/images/users/1.jpg" style="background: url(_/assets/images/users/1.html) center center;"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('assets/backend')}}/images/users/15.jpg" style="background: url(_/assets/images/users/15.html) center center;">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('assets/backend')}}/images/users/12.jpg" style="background: url(_/assets/images/users/12.html) center center;">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="{{asset('assets/backend')}}/images/users/4.jpg" style="background: url(_/assets/images/users/4.html) center center;">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                    <span>
                                        <img src="{{ Auth::user()->profile_photo_path ? asset(Auth::user()->profile_photo_path) : asset('assets/backend/images/faces/admin.png') }}" alt="profile-user"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logoutForm').submit()">
