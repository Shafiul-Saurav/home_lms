                ...
                <div class="predefined_styles">
                    <div class="swichermainleft text-center">
                        <div class="p-3 d-grid gap-2">
                            ...
                            <a href="#" data-bs-target=".buynow-btn" data-bs-toggle="modal" class="btn ripple btn-secondary">Buy Now</a>
                                ...
                                <div class="switch-toggle">
                                    ...
                                    <div class="mt-1">
                                        <a class="bg-img1" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="{{asset('assets/backend')}}/images/media/bg-img1.jpg" alt="Bg-Image" id="bgimage1"></a>
                                        <a class="bg-img2" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="{{asset('assets/backend')}}/images/media/bg-img2.jpg" alt="Bg-Image" id="bgimage2"></a>
                                        <a class="bg-img3" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="{{asset('assets/backend')}}/images/media/bg-img3.jpg" alt="Bg-Image" id="bgimage3"></a>
                                        <a class="bg-img4" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="{{asset('assets/backend')}}/images/media/bg-img4.jpg" alt="Bg-Image" id="bgimage4"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
