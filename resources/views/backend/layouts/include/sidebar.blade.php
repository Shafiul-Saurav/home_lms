                ...
                @canany(['index-course-category', 'index-course-subcategory', 'index-course-childcategory', 'index-course', 'index-instructor-commission'])
                    <li
                        ...
                        <ul class="slide-menu">
                            ...
                            <li class="sub-slide {{ Request::routeIs('commissions.*') ? 'is-expanded' : '' }}">
                                <a class="sub-side-menu__item {{ Request::routeIs('commissions.*') ? 'active' : '' }}"
                                    data-bs-toggle="sub-slide" href="#"><span
                                        class="sub-side-menu__label">Commission
                                        Setting</span><i class="sub-angle fa fa-angle-right"></i></a>
                                <ul class="sub-slide-menu">
                ...
                @canany(['index-book-category', 'index-book-subcategory', 'index-book'])
                    <li
                        ...
                        <a class="side-menu__item {{ Request::routeIs('book_categories.*', 'book_subcategories.*', 'books.*') ? 'active' : '' }}"
                            ...
                            <span class="side-menu__label ms-3">Book Management</span><i
                                class="fa-solid fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            @can('index-book-category')
                                <li class="sub-slide {{ Request::routeIs('book_categories.*') ? 'is-expanded' : '' }}">
                                    <a class="sub-side-menu__item {{ Request::routeIs('book_categories.*') ? 'active' : '' }}"
                                        data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Category
                                            Setting</span><i class="sub-angle fa fa-angle-right"></i></a>
                                    <ul class="sub-slide-menu">
                            ...
                            @endcan
                            @can('index-book-subcategory')
                                <li class="sub-slide {{ Request::routeIs('book_subcategories.*') ? 'is-expanded' : '' }}">
                                    <a class="sub-side-menu__item {{ Request::routeIs('book_subcategories.*') ? 'active' : '' }}"
                                        data-bs-toggle="sub-slide" href="#"><span
                                            class="sub-side-menu__label">Subcategory
                                            Setting</span><i class="sub-angle fa fa-angle-right"></i></a>
                                    <ul class="sub-slide-menu">
                            ...
                            @endcan
                            @can('index-book')
                                <li class="sub-slide {{ Request::routeIs('books.*') ? 'is-expanded' : '' }}">
                                    <a class="sub-side-menu__item {{ Request::routeIs('books.*') ? 'active' : '' }}"
                ...
                @can('index-award')
                    <li class="slide {{ Request::routeIs('awards.*') ? 'is-expanded' : '' }}">
                        <a class="side-menu__item {{ Request::routeIs('awards.*') ? 'active' : '' }}"
                            ...
                            <span class="side-menu__label ms-3">Award Management</span><i
                                class="fa-solid fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            <li class="sub-slide {{ Request::routeIs('awards.*') ? 'is-expanded' : '' }}">
                                <a class="sub-side-menu__item {{ Request::routeIs('awards.*') ? 'active' : '' }}"
                                ...
                                <ul class="sub-slide-menu">
                                    ...
                                    @can('delete-award')
                                        <li><a class="sub-slide-item {{ Request::routeIs('awards.trash') ? 'active' : '' }}"
                                                href="{{ route('awards.trash') }}">Trash</a></li>
                                    @endcan
                                </ul>
                            </li>
                        </ul>
                ...
                @canany(['index-pdf-book-category', 'index-pdf-book-subcategory', 'index-pdf-book'])
                    <li
                        ...
                        <a class="side-menu__item {{ Request::routeIs('pdf_book_categories.*') || Request::routeIs('pdf_book_subcategories.*') || Request::routeIs('pdf_books.*') ? 'active' : '' }}"
                            ...
                            <span class="side-menu__label ms-3">PDF Book Management</span><i
                                class="fa-solid fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            @can('index-pdf-book-category')
                            ...
                            @endcan
                            @can('index-pdf-book-subcategory')
                                <li
                                    class="sub-slide {{ Request::routeIs('pdf_book_subcategories.*') ? 'is-expanded' : '' }}">
