            ...
            <ul class="side-menu">
                ...
                {{-- <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Forms</span><i class="fa-solid fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                    ...
                    <ul class="slide-menu">
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                ...
                                <li><a class="sub-slide-item" href="">Edit</a></li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Charts</span><i class="fa-solid fa-angle-right"></i></a>
                    <ul class="slide-menu">
