    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                {{Request::routeIs('departments.trash') ? 'is-expanded' : ''}}">
                    <a class="side-menu__item {{Request::routeIs('departments.index') ? 'active' : ''}}
                     {{Request::routeIs('departments.trash') ? 'active' : ''}}" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label ms-3">Department</span><i class="fa-solid fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('departments.index') }}" class="slide-item {{Request::routeIs('departments.index') ? 'active' : ''}}"> List</a></li>
                        <li><a href="{{ route('departments.trash') }}" class="slide-item {{Request::routeIs('departments.trash') ? 'active' : ''}}"> Trash</a></li>
                    </ul>
                </li>
                <li class="slide {{Request::routeIs('staffs.index') ? 'is-expanded' : ''}}
                    {{Request::routeIs('staffs.trash') ? 'is-expanded' : ''}}">
                    <a class="side-menu__item {{Request::routeIs('staffs.index') ? 'active' : ''}}
                    {{Request::routeIs('staffs.trash') ? 'active' : ''}}" data-bs-toggle="slide" href="#">
                        <i class="fa-solid fa-clipboard-user fa-fw"></i>
                        <span class="side-menu__label ms-3">Staff</span><i class="fa-solid fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('staffs.index') }}" class="slide-item {{Request::routeIs('staffs.index') ? 'active' : ''}}"> List</a></li>
                ...
                <li class="slide {{Request::routeIs('testimonials.index') ? 'is-expanded' : ''}} {{Request::routeIs('testimonials.trash') ? 'is-expanded' : ''}}">
                    <a class="side-menu__item {{Request::routeIs('testimonials.index') ? 'active' : ''}} {{Request::routeIs('testimonials.trash') ? 'active' : ''}}" data-bs-toggle="slide" href="#">
                    <i class="fa-regular fa-comment-dots"></i>
                        <span class="side-menu__label ms-3">Testimonial Setting</span><i class="fa-solid fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('testimonials.index') }}" class="slide-item {{Request::routeIs('testimonials.index') ? 'active' : ''}}">List</a></li>
                        <li><a href="{{ route('testimonials.trash') }}" class="slide-item {{Request::routeIs('testimonials.trash') ? 'active' : ''}}">Trash</a></li>
                    </ul>
                </li>
                <li class="slide {{Request::routeIs('postcategories.index') ? 'is-expanded' : ''}}
                    ...
                    <ul class="slide-menu">
                        <li class="sub-slide {{Request::routeIs('postcategories.index') ? 'is-expanded' : ''}}
                            {{Request::routeIs('postcategories.trash') ? 'is-expanded' : ''}}">
                            <a class="sub-side-menu__item {{Request::routeIs('postcategories.index') ? 'active' : ''}}
                                {{Request::routeIs('postcategories.trash') ? 'active' : ''}}" data-bs-toggle="sub-slide" href="#"><span
                                    class="sub-side-menu__label">Post Category Setting</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                ...
                {{Request::routeIs('products.index') ? 'is-expanded' : ''}}">
                    ...
                    <ul class="slide-menu">
                        <li class="sub-slide {{Request::routeIs('categories.index') ? 'is-expanded' : ''}}
                        {{Request::routeIs('categories.trash') ? 'is-expanded' : ''}}">
                            <a class="sub-side-menu__item {{Request::routeIs('categories.index') ? 'active' : ''}}
                            {{Request::routeIs('categories.trash') ? 'active' : ''}}" data-bs-toggle="sub-slide" href="#"><span
                                    class="sub-side-menu__label">Category Setting</span><i
                                    class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Sub-menus</span><i class="fa-solid fa-angle-right"></i></a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Apps</span><i class="fa-solid fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">UI Elements</span><i class="fa-solid fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Advanced UI</span><i class="fa-solid fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Pages</span><i class="fa-solid fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Utilities</span><i class="fa-solid fa-angle-right"></i></a>
                    <ul class="slide-menu">
