        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                    <h3 class="card-title">FAQ Trashed List</h3>
                    <a href="{{ route('faqs.index') }}" class="btn btn-outline-info border"><i class="fa-solid fa-angles-left fa-fw"></i> Back</a>
                </div>
                <div class="card-body">
                        ...
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom w-100">
                            ...
                            <tbody>
                                @foreach ($faqs as $faq)
                                    <tr>
                                        <td>
                                            <strong>{{ $faqs->firstItem() + $loop->index }}</strong>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns d-flex align-items-center">
                                                <div>
                                                    <a href="{{ route('faqs.restore', ['id' => $faq->id]) }}"
                                                ...
                                                <div>
                                                    <form action="{{ route('faqs.forcedelete', ['id' => $faq->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
