                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    @enderror" id="faq_question"
                                        value="{{ old('faq_question') }}" required>
                                    @error('faq_question')
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="faq_answer" id=""
                                        ...
                                        is-invalid
                                    @enderror"
                                        id="faq_answer" cols="30" rows="5">{{ old('faq_answer') }}</textarea>
                                    @error('faq_answer')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns d-flex align-items-center">
                                                <div>
                                                    <a href="{{ route('faqs.show', $faq->id) }}" class="btn btn-sm btn-outline-primary border me-2"
