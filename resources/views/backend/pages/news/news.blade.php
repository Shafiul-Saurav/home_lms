        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                    ...
                    {{-- @can('delete-news') --}}
                    <a href="{{ route('admin.news.trash') }}" class="btn btn-sm btn-outline-warning border"><i
                ...
                <div class="card-body">
                    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    <label for="news_image">Image <span class="text-danger">*</span></label>
                                    <input type="file" name="news_image" class="dropify" data-default-file=""
                                        data-height="200" data-max-width="900" data-max-height="800" data-show-errors="true"
                                        data-errors-position="outside" data-allowed-file-extensions="png jpg webp" required/>
                            ...
                            <tbody>
                                @foreach ($news as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('uploads/news') }}/{{ $item->news_image }}" alt=""
                                                style="height: 100px">
                                        </td>
                                        ...
                                        <td>
                                            <div class="material-switch">
                                                <input id="active-{{ $item->id }}" class="toggle-class-active" name="is_active"
                                        ...
                                        {{-- @canany(['edit-news', 'delete-news']) --}}
                                            <td class="text-center">
                                                <div class="action-btns d-flex align-items-center">
                                                    {{-- @can('edit-news') --}}
                                                        <div>
                                                            <a href="{{ route('admin.news.show', $item->id) }}" class="btn btn-sm btn-outline-primary border me-2"
        ...
        $(document).ready(function() {
            $(document).on('change', '.toggle-class-home', function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: `/admin/check/news/is_home/${item_id}`,
            ...
            $(document).on('change', '.toggle-class-active', function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: `/admin/check/news/is_active/${item_id}`,
                    success: function(response) {
                        console.log(response);
                        Swal.fire({
                            title: response.message,
