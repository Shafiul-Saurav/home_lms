        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                    ...
                    <a href="{{ route('product_categories.index') }}" class="btn btn-info"><i class="fa-solid fa-angles-left fa-fw"></i> Back</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('product_categories.update', $category->slug) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            ...
                            <div class="col-6 mb-3">
                                <div class="form-group">
                                    ...
                                    @if($category->file)
                                        <div class="mt-2">
                                            <p>Current File:</p>
                                            <img src="{{ asset('uploads/product_categories/' . $category->file) }}" alt="{{ $category->name }}" style="width: 100px; height: 100px; object-fit: contain;" class="img-thumbnail mb-2">
                                        </div>
                                    @endif
                                </div>
                            </div>
