    ...
    <div class="row">
        <div class="col-12">
            <div class="page-header">
                <div>
                    <h1 class="page-title">PDF Book Orders</h1>
                </div>
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">PDF Book Orders</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">PDF Book Order List</h3>
                </div>
                <div class="card-body">
                        ...
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">PDF Book</th>
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>{{ optional($order->pdfBook)->name ?? optional($order->pdfBook)->title ?? '-' }}</td>
