        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                    <h3 class="card-title">Order Edit - {{ $order->order_number }}</h3>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark">Tk {{ number_format($item->price) }}</td>
                                    <td class="text-dark">{{ $item->quantity }}</td>
                                    <td class="text-dark">Tk {{ number_format($item->total) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
