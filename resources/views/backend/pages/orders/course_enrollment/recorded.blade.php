...
@section('title', 'Recorded Course Enrollment Orders')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-header">
                <div>
                    <h1 class="page-title">Recorded Course Enrollment Orders</h1>
                </div>
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Recorded Course Enrollment</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                    <h3 class="card-title">Recorded Course Enrollment List</h3>
                                ...
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif(optional($order->course)->live_or_record === 'record')
