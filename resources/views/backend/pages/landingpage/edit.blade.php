                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="benefits_list" id="summernote-benefits" class="form-control @error('benefits_list') is-invalid @enderror" rows="4" placeholder="Enter benefits with HTML formatting">{{ old('benefits_list') ?: ($landingPage->benefits_list ? (is_array($landingPage->benefits_list) ? implode("\n", $landingPage->benefits_list) : $landingPage->benefits_list) : '') }}</textarea>
                                    @error('benefits_list')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
