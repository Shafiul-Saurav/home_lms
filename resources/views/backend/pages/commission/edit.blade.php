...
@section('title', 'Edit Instructor Commission')
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                    <h3 class="card-title">Update Commission Proposal</h3>
                        ...
                        <div class="form-row">
                                    ...
                                    <select name="teacher_id" id="teacher_id"
                                        ...
                                        @foreach ($teachers as $teacher)
                                            <option value="{{ $teacher->id }}"
                                                {{ old('teacher_id', $commission->teacher_id) == $teacher->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        @foreach (['pending' => 'Pending', 'approved' => 'Approved', 'rejected' => 'Rejected'] as $value => $label)
                                            <option value="{{ $value }}"
                                                {{ old('status', $commission->status) === $value ? 'selected' : '' }}>
                                                {{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                            ...
                            <div class="col-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="admin_percentage"
                                        ...
                                        id="admin_percentage"
                                        value="{{ old('admin_percentage', $commission->admin_percentage) }}" min="0"
                            ...
                            <div class="col-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="gateway_percentage"
                                        ...
                                        id="gateway_percentage"
                                        value="{{ old('gateway_percentage', $commission->gateway_percentage) }}"
                            ...
                            <div class="col-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="instructor_percentage"
                                        value="{{ number_format($commission->instructor_percentage, 2) }}%" readonly>
                                </div>
                            </div>
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="negotiation_note" id="negotiation_note" data-summernote rows="4"
                                        class="form-control @error('negotiation_note') is-invalid @enderror">{{ old('negotiation_note', $commission->negotiation_note) }}</textarea>
