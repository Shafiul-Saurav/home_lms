    ...
    <div class="row">
        <div class="col-12">
            <div class="page-header">
                <div>
                    <h1 class="page-title">What You Get</h1>
                </div>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between">
                    <h3 class="card-title">Create What You Get</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('whatyougets.store') }}" method="POST">
                        @csrf
                        <div class="form-row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">What You Get List</h3>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns d-flex align-items-center">
                                                <div>
                                                    <a href="{{ route('whatyougets.edit', $item->id) }}" class="btn btn-sm btn-outline-secondary border me-2">
                                                        <i class="fa-solid fa-pen fa-fw"></i>
                                                    </a>
                                                </div>
                                                <div>
                                                    <form action="{{ route('whatyougets.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
        ...
        $(document).ready(function() {
            $(document).on('change', '.toggle-class-active', function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: `/admin/check/whatyouget/is_active/${item_id}`,
