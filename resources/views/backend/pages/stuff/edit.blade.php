    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('staffs.update', $stuff->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror">
                                        ...
                                        @forelse ($departments as $department)
                                            <option value="{{ $department->id }}" @if ($stuff->department_id == $department->id)
                                                selected
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    @enderror" id="full_name"
                                        value="{{ old('full_name', $stuff->full_name) }}" required>
                                    @error('full_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="bio" id="summernote" cols="30" rows="10" required>{!! $stuff->bio !!}</textarea>
                                </div>
                            </div>
                            <div class="col-12 mb-3">
                                  <div class="form-group">
                                    ...
                                    <select class="form-control select2 form-select select2-hidden-accessible" name="salary_type" data-placeholder="Choose one">
                                        ...
                                        <option value="monthly" @if ($stuff->salary_type == 'monthly') selected @endif>Monthly</option>
                                        <option value="daily" @if ($stuff->salary_type == 'daily') selected @endif>Daily</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    @enderror" id="salary_amount"
                                        value="{{ old('salary_amount', $stuff->salary_amount) }}" required>
                                    @error('salary_amount')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
