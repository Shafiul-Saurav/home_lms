...
@section('frontendone_content')
    <main class="main">
        <x-frontend.pages.common.breadcrumb :title="$subcategory->name . ' Courses'" :breadcrumb="[
            ['name' => 'Home', 'url' => route('home')],
            ['name' => $subcategory->name . ' Courses', 'url' => '#'],
        ]" />
                ...
                <div class="row g-4">
                    <div class="section-heading">
                        <span class="sub-title">
                            ...
                            <h2 class="mb-0">All Subcategory Courses</h2>
                        </span>
                    </div>
                            ...
                            <div id="course-grid">
                                ...
                                @else
                                    <div class="alert alert-warning text-center mb-0">
                                        ...
                                        <p>We couldn't find any courses in this subcategory right now. Please check back
                                            later or browse another category.</p>
                                    </div>
                                @endif
                            </div>
                        </div>
