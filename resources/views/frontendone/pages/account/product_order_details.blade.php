...
@section('frontendone_content')
    <main class="main">
        <!-- breadcrumb -->
        <x-frontend.pages.common.breadcrumb :title="'Product Order Details'" :breadcrumb="[
            ['name' => 'Home', 'url' => route('home')],
            ['name' => 'Product Orders', 'url' => route('user.product.orders')],
                        ...
                        <div class="user-wrapper">
                            <div class="user-card">
                                <div class="header d-flex justify-content-between align-items-center">
                                    <h4 class="title">Product Order Details</h4>
                                    <a href="{{ route('user.product.orders') }}" class="theme-btn">Back to Orders</a>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('product.details', $order->product_id) }}"
                                                            ...
                                                            {{ $order->product?->name ?? 'Product details' }}
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($ostat === 'delivered' || $ostat === 'completed')
