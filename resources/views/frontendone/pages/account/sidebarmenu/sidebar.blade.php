<div class="user-sidebar">
    ...
    <ul class="sidebar-list">
        ...
        <li>
            <a href="notification.html"><i class="far fa-bell icon"></i> Notification <span class="badge badge-danger">02</span></a>
        </li>
        <li>
            <a href="message.html"><i class="far fa-envelope icon"></i> Messages <span class="badge badge-danger">02</span></a>
        </li>
        <li>
