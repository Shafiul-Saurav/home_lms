                                ...
                                <div class="user-table table-responsive">
                                    <table class="table table-borderless table-hover align-middle text-nowrap">
                                        ...
                                        <tbody>
                                                    ...
                                                    <td>
                                                        <div class="action-dropdown dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end" style="max-height: none !important; overflow: visible !important;">
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('book.order.details', $order) }}"><i class="fa-solid fa-eye"></i> Order Details</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item" href="{{ route('book.details', $order->book_id) }}"><i class="fa-solid fa-book"></i> View Book</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center py-4">You have no book orders yet.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
