        ...
        <div class="blog-area py-5">
            <div class="container">
                ...
                <div class="text-center mt-4 mb-5">
                    @auth
                        <button type="button" class="nav-action mt-5" style="border: none;" onclick="openCpModal()">Create New
                            Post</button>
                    @else
                ...
                <div class="cp-modal" id="cpModal">
                    ...
                    <div class="cp-modal-body">
                        ...
                        <div class="notice-box warning">
                            ...
                            <span>Your post will be <strong>reviewed by admin</strong> before it goes live. This usually takes
                        ...
                        <form action="{{ route('user.posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="cp-form-group">
                                ...
                                <input type="text" name="title" id="cp_title"
                                    class="cp-input @error('title') is-invalid @enderror" placeholder="Enter an engaging title…"
                            ...
                            <div class="cp-row">
                                <div class="cp-form-group">
                                    ...
                                    <textarea name="description" id="cp_description" rows="4"
                                        class="cp-textarea @error('description') is-invalid @enderror" placeholder="Main post content…">{{ old('description') }}</textarea>
                                    @error('description')
                            ...
                            <div class="cp-form-group">
                                ...
                                <div class="cp-upload-zone">
                                    <input type="file" name="post_image" id="cp_post_image" accept=".jpg,.jpeg,.png"
