        ...
        <div class="blog-area py-5">
            <div class="container">
                ...
                <div class="text-center mt-4 mb-5">
                    @auth
                        <button type="button" class="nav-action mt-5" style="border: none;" onclick="openCpModal()">Submit News</button>
                    @else
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="news-card">
                                ...
                                <div class="news-content">
                                    ...
                                    <h3>{{ $item->title }}</h3>
                                    <p>{{ \Illuminate\Support\Str::words(strip_tags($item->short_des ?? $item->description), 15, '...') }}</p>
            ...
            <div class="cp-modal" id="cpModal">
                ...
                <div class="cp-modal-body">
                    ...
                    <div class="notice-box warning">
                        ...
                        <span>Your news submission will be <strong>reviewed by admin</strong> before it goes live. This usually takes 1–2 business days.</span>
                    </div>
                    ...
                    <form action="{{ route('frontend.news.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="cp-row">
                            <div class="cp-form-group">
                                ...
                                <textarea name="description" id="cp_description" rows="4"
                                    ...
                                    placeholder="Main news content…">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="cp-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="cp-form-group">
                            ...
                            <div class="cp-upload-zone">
                                <input type="file" name="news_image" id="cp_news_image"
                                    accept=".jpg,.jpeg,.png"
