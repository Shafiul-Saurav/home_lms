...
@push('frontendone_style')
    ...
    <style>
        ...
        /* Modern login styling matching CyberBD style guidelines */
        .auth-area {
            background: #f8fafc;
            padding: 90px 0;
        }
...
@section('frontendone_content')
    <main class="main">
        <!-- Breadcrumb section -->
        <x-frontend.pages.common.breadcrumb :title="'Sign In'" :breadcrumb="[['name' => 'Home', 'url' => route('home')], ['name' => 'Login', 'url' => '#']]" />
                    ...
                    <div class="col-lg-5 col-md-8 mx-auto">
                        <div class="auth-form">
                            <div class="auth-header">
                                ...
                                @endif
                                <p>Login with your CyberBD account</p>
                            </div>
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="auth-group">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" class="auth-group-link">Forgot
                                            Password?</a>
                                    @endif
                                </div>
                                <div class="auth-btn">
